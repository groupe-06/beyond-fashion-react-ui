...
const ChatApp = () => {
  ...
  const [users, setUsers] = useState([
    ...
    },
    {
      ...
      name: 'Issa Diol',
      status: 'il y a 5 min',
      image: 'WhatsApp Image 2024-10-09 at 09.01.41.jpeg',
      stories: [
        { id: 1, content: 'WhatsApp Image 2024-04-29 at 15.40.54.jpeg', duration: 5, viewed: false }
      ],
      personalInfo: {
        address: "Guediawaye",
        phone: "+221 77 123 45 67",
        email: "issadiol@email.com",
        bio: "Développeur passionné | Amateur de football ⚽",
        profileImage: "WhatsApp Image 2024-10-09 at 09.01.41.jpeg"
      },
      stats: {
        likes: 8750,
        followers: 1230,
      ...
      posts: [
        { id: 1, type: 'image', url: '/api/placeholder/200/200', likes: 145 },
        { id: 2, type: 'image', url: '/api/placeholder/200/200', likes: 278 }
      ],
      liked: [
        { id: 3, type: 'image', url: '/api/placeholder/200/200', likes: 98 },
        { id: 4, type: 'image', url: '/api/placeholder/200/200', likes: 176 }
      ],
      saved: [
        { id: 5, type: 'image', url: '/api/placeholder/200/200', likes: 321 }
      ],
      shared: [
        { id: 6, type: 'image', url: '/api/placeholder/200/200', likes: 187 }
      ]
    }
  ]);
